<?php
    ...
    $conexion=conexion();
    $sql="SELECT COUNT(area_id), area_id, nombre_area FROM servicios INNER JOIN areas ON area_id = id_area GROUP BY area_id HAVING COUNT(*)";
...
<script type="text/javascript">
    ...
    var layout = {
        title: 'Tipos de Servicio Registrados',
        xaxis: {
            title: 'Areas'
        },
        yaxis: {
