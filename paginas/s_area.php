<?php
    ...
    if(isset($_POST['areas_select'])){
        ...
        if ($lista_areas==NULL){
            echo '<select name="sarea" id="sarea" class="form-control"><option value="0">No hay areas registradas</option>';
        }
        else{
            $output = '<select name="sarea" id="sarea" class="form-control"><option value="0">Seleccione Area:</option>';
