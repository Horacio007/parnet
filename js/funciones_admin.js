$(document).ready(function (){
    ...
    $("#bnav5").click(function () {
        ...
        $.ajax({
            url: "/parnett/paginas/productos_admin.php",
            success: function (result) {
                $("#principal").html(result);
            }
        });
...
//----------------------------------------------------------------//
    ...
    $("#noticias").on('click', function(){
        $.ajax({
            url: '/parnett/paginas/noticias_admin.php',
            success: function(result) {
                $("#principal").html(result);
            }
        });
    ...
    //Boton de adminstracion lateral
    $("#btn11").on('click', function(){
        $.ajax({
            url: '/parnett/paginas/login_cerrar.php',
            success: function(result) {
                $("#principal").html(result);
            }
        });
...
//----------------------------------------------------------------//
    ...
    $("#foo9btn").click(function () {
        $.ajax({
            url: '/parnett/paginas/sugerencias_admin.php',
            success: function(result) {
                $("#principal").html(result);
            }
        });
    ...
    //Boton de sugerencias del footer
    $("#foo10btn").click(function () {
        $.ajax({
            url: '/parnett/paginas/grafica1.php',
            success: function(result) {
                $("#principal").html(result);
            }
        });
